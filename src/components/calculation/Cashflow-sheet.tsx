...
import CashflowTable from "./tables/Cashflow.table";
...
function CashflowSheet() {
  ...
  if (!isLoading) {
    content = <CashflowTable business={data?.business} />;
  }
  return (
    <React.Fragment>
      <div className="p-3 md:p-5">
        ...
        <div>
          ...
          <div className="flex gap-2 md:gap-5 md:flex-row flex-col item-center my-5">
            ...
            <Link
              className="button text-center"
              to={`/create-business/projection/${id}`}
            >
              {t("go_to_projection")}
            </Link>
            <button
