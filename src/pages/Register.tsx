    ...
    <section>
      <div className="flex h-full md:h-screen w-full">
        <div className="flex flex-col gap-3 items-start justify-center p-5 md:p-20 w-full lg:w-6/12 ">
          <h2 className="text-bold text-xl md:text-4xl leading-snug">
            {t("register_a_ser")}
          </h2>
          <p className="text-thin text-base">{t("by_singing_up")}</p>
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full">
            <div className="flex-col xl:flex-row flex gap-5 w-full">
              <span className="flex flex-col gap-2 w-full">
                <label className="text-normal text-base">{t("username")}</label>
                <input
                  type="text"
                  name="username"
                  value={username}
            ...
            <div className="flex-col xl:flex-row flex gap-5">
