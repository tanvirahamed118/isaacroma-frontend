...
import PersonalExpenseList from "./categoryList/Personal.expense.list";
  ...
  return (
    <div className="w-full bg-white border border-gray-300 rounded-lg">
      <div className="p-5 md:p-10">
        <h2 className="text-bold text-3xl jost">Enter Personal Expense Info</h2>
