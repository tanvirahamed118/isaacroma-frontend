...
import ExtraoridinayExpenseList from "./categoryList/Extraoridinay.expense.list";
...
function AddExtraordinaryExpense() {
  ...
  return (
    <div className="w-full bg-white border border-gray-300 rounded-lg">
      <div className="p-5 md:p-10">
        <h2 className="text-bold text-3xl jost">
          {t("enter_extraordinary_info")}
        </h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 pt-5">
          <div className="flex md:flex-row flex-col gap-5 items-center">
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                placeholder={t("enter_extraordinary__name")}
                required
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                value={firstYear}
                onChange={handleChange}
                placeholder={t("enter_extraordinary_Price")}
                required
          ...
          <div className="flex flex-col gap-1 w-full">
            <label htmlFor="" className="text-normal text-lg jost">
              {t("extraordinary_expense_percent")}
            </label>
            <input
              type="number"
              ...
              onChange={handleChange}
              placeholder={t("enter_extraordinary_expense_percent")}
              required
              className="text-lg text-normal jost py-2 px-4 rounded-md w-full border border-gray-300"
            />
          </div>
          {chose?.name ? (
            ...
            >
              {isLoading ? (
                ...
                t("create_extraordinary_expense")
              )}
            </button>
          )}
        </form>
      ...
      <div className="p-5">
        <h2 className="jost text-2xl text-medium pb-5">
          {t("create_extraordinary_expense")}
        </h2>
        <ExtraoridinayExpenseList
          setChose={setChose}
          setShow={setShow}
          show={show}
        />
...
export default AddExtraordinaryExpense;
