...
import CapitalIncreaseList from "./categoryList/Capital.increase.list";
    ...
    <div className="w-full bg-white border border-gray-300 rounded-lg">
      <div className="p-5 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 pt-5">
          <div className="flex md:flex-row flex-col gap-5 items-center">
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                placeholder={t("enter_capital_increase_loan_name")}
                required
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                value={firstYear}
                onChange={handleChange}
                placeholder={t("enter_capital_increase_loan_price")}
                required
          ...
          <div className="flex flex-col gap-1 w-full">
            <label htmlFor="" className="text-normal text-lg jost">
              {t("capital_increase_loan_percent")}
            </label>
            <input
              type="number"
              ...
              onChange={handleChange}
              placeholder={t("enter_capital_increase_loan_percent")}
              required
              className="text-lg text-normal jost py-2 px-4 rounded-md w-full border border-gray-300"
            />
          </div>
...
export default AddCapitalIncrease;
