...
import FinancialExpenseList from "./categoryList/Financial.expense.list";
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 pt-5">
          <div className="flex md:flex-row flex-col gap-5 items-center">
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                placeholder={t("enter_financial_expense")}
                required
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <input
                ...
                value={firstYear}
                onChange={handleChange}
                placeholder={t("enter_financial_expense_price")}
                required
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder={t("enter_financial_expense_percent")}
              required
              className="text-lg text-normal jost py-2 px-4 rounded-md w-full border border-gray-300"
            />
          </div>
