...
function ExtraoridinayExpenseList({ setChose, setShow, show }: DataType) {
  ...
  const category = data?.business?.categories?.filter(
    (item: { category: string }) => item?.category === "EXTRAORDINARY"
  );
...
export default ExtraoridinayExpenseList;
